        ...
        <div id="sequence">
            ...
            <ul class="sequence-canvas">
                <li class="animate-in">
                    ...
                    <div class="flat-button caption4 formLeft delay600 text-center"><a class="more"
                            href="#">More Details</a></div>
                    <div class="flat-image formBottom delay200" data-duration="5" data-bottom="true"><img
                            src="{{ asset('images/slider-image-01.png') }}" alt=""></div>
                </li>
                <li>
                    ...
                    <div class="flat-image formBottom delay200" data-bottom="true"><img
                            src="{{ asset('images/slider-image-02.png') }}" alt=""></div>
                </li>
                <li>
                    <div class="flat-caption caption2 formLeft delay400 text-center">
                    ...
                    <div class="flat-button caption4 formLeft delay600 text-center"><a class="more"
                            href="#">More Details</a></div>
                    <div class="flat-image formBottom delay200" data-bottom="true"><img
                            src="{{ asset('images/slider-image-03.png') }}" alt=""></div>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="promo-box"><img src="{{ asset('images/promotion-01.png') }}" alt=""></div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="promo-box"><img src="{{ asset('images/promotion-02.png') }}" alt=""></div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="promo-box"><img src="{{ asset('images/promotion-03.png') }}" alt=""></div>
                </div>
            </div>
        </div>
    </div>
